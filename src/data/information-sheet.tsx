...
export const ACTION_INFO =
  "Please read all sections of this information sheet to continue.";
export const ACTION_LABEL = "I have read this information sheet";
        ...
        text: (
          <>
            ...
            <Typography sx={{ mb: 2 }}>
              ...
              within the context of a task-based user interface (UI). This
              project is being undertaken by Des McDonnell for our major
            ...
            <Typography>
              Before you decide whether you wish to take part, it is important
              for you to understand why this research is being done and what it
              will involve. Please take time to read this information carefully
              and discuss it with someone you trust. If there is anything that
              is unclear or if you would like more information please ask, our
              contact details are at the end of this information sheet. Thank
    ...
    content: [
      {
        ...
        text: (
          <Typography>
            As digital information systems become more prevalent in our lives,
            the need to receive status updates and other forms of notifications
            from the applications we rely on has increased significantly. As
            autonomous AI agents become more prevalent, it is expected that this
            requirement will only increase. This study aims to investigate the
            impact of these notifications on flow state and the performance of
    ...
    content: [
      {
        ...
        text: (
          <Typography>
            ...
            graduate student at IADT and as such meet the minimum age
            requirement of 18 years and have a competent level of computer
            literacy and familiarity with common UI patterns and conventions.
          </Typography>
        ),
      },
    ],
    ...
    content: [
      {
        ...
        text: (
          <>
            <Typography sx={{ mb: 2 }}>
              If you choose to proceed as a participant in this study you will
              be asked to complete a web-based experiment comprising of
              pre-task, primary task and post-task parts.
            </Typography>
            ...
            <Typography sx={{ mb: 2 }}>
              Prior to the task, you will asked to record your particulars,
              confirm that you meet the requirements for the study and register
              your consent.
            </Typography>

            <Typography sx={{ mb: 2 }}>
              You will also be requested to complete the Media
              Multitasking-Revised (MMT-R) questionnaire. This will involve a
              series of 18 questions related to your general Media Multitasking
              behaviour. Responses will be based on a likert rating scale.
            </Typography>
            ...
            <Typography sx={{ mb: 2 }}>
              For the primary task, you will be requested to play a game of
              Tetris using the arrow keys on your keyboard.
            </Typography>
            <Typography sx={{ mb: 2 }}>
              The score you achieve and the time taken to complete this task
              will be recorded and later analysed.
            </Typography>
            <Typography sx={{ mb: 2 }}>
              Note that your score and time will not be displayed on screen
              during the game to avoid additional distractions.
            </Typography>
            <Typography sx={{ mb: 2 }}>
            ...
            <Typography sx={{ mb: 2 }}>
              ...
              screen. While this notifications are visible, the primary task
              will be paused. Active notifications will require a response to
              continue. You can response by clicking either 'Yes' or 'No' with
              your mouse.
            </Typography>
            ...
            <Typography sx={{ mb: 2 }}>
              On completion of the primary task, you will be asked to complete
              the Flow State Scale (FSS-2) questionnaire. This will comprise of
              36 questions related to any flow state experienced during the
              primary task. Responses will be based on a likert rating scale.
            </Typography>

            <Typography sx={{ mb: 2 }}>
              Finally, you will be presented with debrief information and a
              participant code. Please record your participant code and
              reference it if you decide to withdraw from the study after
              completion.
            </Typography>

            <Typography sx={{ mb: 2 }}>
              It is estimated that the study will take approximately 15 minutes
              in addition to the primary task time (which is dependent on
              ability) to complete.
            </Typography>
          </>
        ),
        ...
        text: (
          <>
            <Typography sx={{ mb: 2 }}>
              ...
              abnormal amount and frequency of user interface notifications. It
              is acknowledged that this may result in short-term frustration
              which is expected to alleviate on completion of the experiment.
            </Typography>
            <Typography>
              If at any point throughout your involvement, you deem this
              frustration to be overwhelming, you may choose to opt-out
    ...
    content: [
      {
        ...
        text: (
          <Typography>
            ...
            . This study may also be published in an academic journal article
            and may be written about for blog posts or media articles which can
        ...
        text: (
          <>
            <Typography sx={{ mb: 2 }}>
              ...
              interest. The regulations regarding the protection of your data
              will be followed. Only data which is needed for analysis will be
              collected.
            </Typography>
            <Typography sx={{ mb: 2 }}>
              ...
              sheet. The data will be retained by the researcher for at least
              one year and may be retained for up to 7 years if the results of
              the study are published in certain capacities (e.g. in a journal
              ...
              if this occurs it will be ensured that you are not identifiable
              from the data.
            </Typography>
            <Typography sx={{ mb: 2 }}>
              ...
              to a journal will be fully deleted on or before April 30th 2032.
            </Typography>
            <Typography sx={{ mb: 2 }}>
              ...
              completing the study, data will be stored in a cloud-based
              database. On completion, data will be exported and stored in
              encrypted form on password-protected computers only.
            </Typography>
            <Typography sx={{ mb: 2 }}>
              If a data breach occurs at any point, the data protection officer
              in IADT will be informed immediately. All data collected and
              stored will be fully anonymous with no identifiable properties.
            </Typography>
            <Typography>
              On or before the 30th of April 2032, copies of data held by the
              researcher and supervisor will be fully deleted. You will find
        ...
        content: [
          {
            ...
            text: (
              <>
                <Typography>
                  If you have a concern about any aspect of this study, you may
                  wish to speak to the researcher who will do their best to
                  answer your questions.
                </Typography>
                <Typography>
                  You should contact Des McDonnell via email at{" "}
                  <Link
                    href="mailto:N00236157@student.iadt.ie"
                    color="secondary"
                  >
                    N00236157@student.iadt.ie
                  </Link>
