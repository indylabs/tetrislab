...
export const INFORMATION_DATA = [
  {
    id: 1,
    title: "Project title and introduction",
    content: [
      {
        id: 1,
        text: (
        ...
        content: [
          {
            ...
            text: (
              <>
                ...
                wish to speak to the researcher who will do their best to answer
                your questions.
              </>
            ),
          },
          {
            ...
            text: (
              <>
                ...
                <a href="mailto:Liam.Challenor@iadt.ie">
