...
export const DEBRIEF_DATA = [
    ...
    content: (
      <>
        ...
        <Typography sx={{ mb: 2 }}>
          ...
          notifications on flow state and performance within the context of a
  ...
  },
  {
    ...
    content: (
      <>
        <Typography sx={{ mb: 2 }}>
          It is acknowledged that your participation in this experiment may have
          resulted in short-term frustration which is expected to alleviate on
          completion.
        </Typography>
        <Typography sx={{ mb: 2 }}>
        ...
        <Typography sx={{ mb: 2 }}>
          Address: Student Services Area, Office C006b, Carriglea Building, IADT
        </Typography>
        <Typography sx={{ mb: 2 }}>
          Email:{" "}
        ...
        <Typography>
          Web:{" "}
          <Link href="https://www.jigsaw.ie/" target="_blank" color="secondary">
            https://www.jigsaw.ie/
          </Link>
        </Typography>
      </>
